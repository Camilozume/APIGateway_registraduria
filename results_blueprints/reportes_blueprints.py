...
@reports_blueprints.route("/reports/voto/sorted_candidato/<string:id_>", methods=["GET"])
...
@reports_blueprints.route("/reports/voto/sorted_partido/<string:id_>", methods=["GET"])
